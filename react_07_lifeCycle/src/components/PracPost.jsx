...
export default function PracPost() {
  const fakePosts = [
    {
      id: 1,
      title:
  ...
  const [posts, setPosts] = useState([]); // fakePosts는 객체가 여러 개 있는 배열 형태로 받아오기 때문에 무엇을 받아올지 몰라서 빈 배열로 초기화!

  useEffect(() => {
    setTimeout(() => {
      // 서버에서 데이터 받아오는 시간을 2초라고 가정
